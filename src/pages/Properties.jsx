...
const Properties = () => {
  ...
  const fetchWishlist = async ()=>{
    try {
        ...
        setWishlistedIds(res.data.filter((item)=> item.property)
          ...
          <aside className={`${s.sidebar} ${showMobileFilters ? s.sidebarVisible : s.sidebarHidden}`}>
            ...
            <div className={s.filtersScrollArea}>
                <div className={s.filterSection}>
                    ...
                    <div className={s.searchInputWrapper}>
                        ...
                        <input type="text" placeholder="Seach by city..." value={filters.city}
                        onChange={(e)=>{
                            const updatedFilters = {
                                ...filters,
                                city: e.target.value
                ...
                <div className={s.filterSection}>
                      ...
                      <div className={s.checkboxGroup}>
                        {propertyTypes.map((type)=>(
                            <label key={type.value} className={s.checkboxLabel}>
                                <input type="checkbox" checked={filters.propertyType.includes(type.value)} 
                    ...
                    <div className={s.filterSection}>
                        ...
                        <div className={s.bhkGroup}>
                          {bhkOptions.map((options)=>(
                            <>
                            <button key={options} onClick={()=> handleBhkSelect(options)} className={`${s.bhkButton} ${filters.bhk === options? s.bhkButtonActive: s.bhkButtonInactive}`}>
                               {options}
                            </button>
                            </>
                          ))}
                    ...
                    <label key={option.value} className={s.checkboxLabel}>
                      <input type="checkbox" checked={filters.furnishing?.includes(option.value)} 
            ...
            <main className={s.mainContent}>
              <div className={s.contentHeader}>
                <div>
               <span className={s.resultCount}>Showing {""}
