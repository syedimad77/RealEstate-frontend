...
const LandingPage = () => {
  ...
  const fetchWishlist = async () => {
    ...
    const handleToggleWishlist = async (propertyId) => {
      try {
        ...
        if (isWishlisted) {
          ...
          setWishlistIds((prevIds) => prevIds.filter((id) => id !== propertyId))
        } else {
          ...
          setWishlistIds((prevIds) => [...prevIds, propertyId])
        }
      } catch (err) {
      ...
      const fetchProperties = async (search = "") => {
        try {
          setLoading(true)
          const response = await axios.get(`${API_URL}/api/property?city=${search}`)
   ...
   const handleSearch = (e) => {
          ...
          if(propertyType !== "selectType") params.append('type', propertyType)
  ...
  return (
    ...
    <section className={s.heroSection}>
      <div className={s.heroContent}>
        ...
        <h1 className={s.heroTitle}>Find your <span className={s.textGradient}>Perfect</span>Next
        Chapter.
        </h1>
        <p className={s.heroSubtitle}>
          Experience the most advance realestate search platform. Discover verified
          listings, connect with trusted agents, and find your dream home with ease. 
        </p>
          ...
          {categories.map((cat, idx)=>{
            return(
              ...
              <div key={idx} className={s.categoryCard} onClick={()=> navigate(`/properties?type=${cat.type}`)}>
                ...
                <p className={s.categoryCount}>{cat.count.toString()} Properties</p>
              </div>
              </>
            )
          })}
  ...
  <div className={s.container}>
    <div className={s.processHeader}>
      ...
      <p className={s.processSubtitle}>
        we've simplified the property search journey into three intuitive steps, ensuring a smooth and efficient
          ...
          <div className={s.container}>
            <div className={s.featuredHeader}>
              ...
              <p className={s.featuredSubtitle}>
                Discover high-value properties curated by our experts, ensuring you have
                 access to the best listings in the market, exceptional design, location and investment potential.
              </p>
            </div>
...
{/* Column 2: Quick Links */}
            ...
            <div>
              ...
              <ul className={s.footerLinks}>
                <li className={s.contactInfo}>
                  ...
                  imad2000syed@gmail.com
                </li>
                <li className={s.contactInfo}>
                  <HiPhone className="text-primary text-xl" /> +919845411097
                </li>
            ...
            {/* column 4 */}
            <div>
              <h4 className={s.footerHeading}>NewLetter</h4>
              <p className={s.newsletterDesc}>
                Subscribe to get the latest listings and market insights
                directtly in your inbox.
              </p>
              <div className={s.newsletterInputWrapper}>
                <input type="text"placeholder="Enter your email" className={s.newsletterInput}/>
    ...
    <div className={s.bottomBar}>
      ...
      <div className={s.designCredit}>
       ...
       target="_blank" className={s.designLink}>
        Syed Imad
       </a>
      </div>
